...
#define LGUEST_DATA_irq_pending 20 /* offsetof(struct lguest_data, irq_pending)	# */
...
#define __NR_syscall_max 348 /* sizeof(syscalls) - 1	# */
#define NR_syscalls 349 /* sizeof(syscalls)	# */
...
#define PARAVIRT_PATCH_pv_irq_ops 180 /* offsetof(struct paravirt_patch_template, pv_irq_ops)	# */
